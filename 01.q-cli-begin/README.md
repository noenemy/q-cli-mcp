시작 전에, Workshop Studio에서 실습 환경을 구성합니다. MacOS/Linux 환경이라면, Q CLI 를 로컬에 설치하여 사용할 수 있습니다. 
...
이제 본격적으로 실습을 시작하세요. [lab1.Begin_Q_Dev_CLI.md](https://github.com/noenemy/q-cli-mcp/blob/main/01.q-cli-begin/lab1.Begin_Q_Dev_CLI.md)
