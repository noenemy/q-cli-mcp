...
```
<img width="1004" height="331" alt="Screenshot 2025-09-08 at 1 49 21 PM" src="https://github.com/user-attachments/assets/3442e391-a33a-4316-a1d3-9f049eb9c74f" />
...
### Prime Day 준비하기
본격적으로 Prime Day를 위한 로드테스트를 준비합니다. Kiro CLI가 생성하는 스크립트를 이용합니다. 
...
### Load Test 실행하기
파일 ddb_load_tester.py 의 작성이 완성되었다면, 사용법을 읽어보고 부하테스트를 시작합니다. (Kiro CLI 에 사용법을 문의해도 좋습니다.)
...
부하가 충분히 발생했다면, 어떻게 대비하면 좋은지 Kiro CLI에 질의합니다.
```
