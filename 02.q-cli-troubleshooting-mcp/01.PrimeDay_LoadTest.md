...
>[!NOTE]
>[현재 위치 내의 ./ddb](.ddb/) 폴더 내에 이미 로드테스트 스크립트의 결과물이 업로드 되어 있습니다. 로드테스트 스크립트를 만드는 데 시간이 소요되니 이미 만들어진 스크립트를 활용해 보세요.
>
<BR>
```
...
```
/home/ec2-user/ddb/ddb_load_tester.py 스크립트를 실행해 주세요
```
<BR>
