...
```
<img width="816" height="618" alt="Screenshot 2025-08-04 at 2 08 04 PM" src="https://github.com/user-attachments/assets/d51279a5-a6c6-40b8-94fe-3bf7d7bc0bbf" />

결과는 Prime Day 진행 시 비용과 평소 비용을 비교 정리한 결과를 보여줍니다.
<img width="570" height="590" alt="Screenshot 2025-08-04 at 2 10 25 PM" src="https://github.com/user-attachments/assets/f31d8614-370d-421e-aa00-60f62eaa87ec" />
<img width="843" height="518" alt="Screenshot 2025-08-04 at 2 10 40 PM" src="https://github.com/user-attachments/assets/7dd8cf8f-96e1-4d06-a4e9-3a5b0862ccc7" />


### 결과 보고를 위한 리포트 만들기
html 페이지로 테스트 진행한 내용을 생성합니다.
```
Prime Day 대비를 위해 진행한 로드 테스트의 내용과 장애 대응,
그리고 예상 비용을 요약 정리한 리포트를 html 페이지로 만들어 주세요.
```
