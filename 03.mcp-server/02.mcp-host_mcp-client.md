...
### 0. Bedrock Model Access
Bedrock Console > Model Access > Modify model access > Nova lite 를 선택하고 Save를 눌려줍니다.
...
> [!TIP]
> 기동된 weather3.py의 서비스 URL과 포트를 확인 : ex) http://localhost:8123 <BR>
...
> weather 폴더 및에 client 폴더 생성이 필요합니다. <BR>
